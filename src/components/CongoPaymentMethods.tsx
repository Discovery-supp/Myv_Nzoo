        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="text-sm text-blue-700 dark:text-blue-300">
            ...
            <ul className="space-y-1 text-xs">
              <li>• {language === 'fr' ? 'Paiement 100% sécurisé par CinetPay' : '100% secure payment by CinetPay'}</li>
              <li>• {language === 'fr' ? 'Aucun frais supplémentaire' : 'No additional fees'}</li>
              <li>• {language === 'fr' ? 'Confirmation instantanée' : 'Instant confirmation'}</li>
            </ul>
          </div>
        </div>
      </div>
